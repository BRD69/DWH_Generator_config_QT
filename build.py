...
def get_pyinstaller_args(is_mac, is_windows, build_path, icon_path):
    ...
    args = [
        ...
        # f'--add-data=resources/images/icon256.png{separator}resources/images',
        # f'--add-data=resources/images/icon128.png{separator}resources/images',
        # f'--add-data=resources/images/icon64.png{separator}resources/images',
        # f'--add-data=resources/images/icon32.png{separator}resources/images',
        # f'--add-data=resources/images/icon16.png{separator}resources/images',
        '--clean',
        '--noconfirm',
